...
const TourNhaTrang = () => {
  ...
  const carouselImages = [
    [
      "https://datphutourist.com/upload/product/hinhanhdepvenhatrangthanhphobien3-901.jpg",
      "https://gcs.tripi.vn/public-tripi/tripi-feed/img/474153HdW/anh-bai-bien-nha-trang-dep_085935532.jpg",
      "https://wall.vn/wp-content/uploads/2020/04/hinh-anh-nha-trang-7.jpg",
      "https://nhatrang-travel.com/upload/2001105/20200519/nha-trag-10_821cc.jpg",
    ],
  ];
              ...
              {carouselImages.map((imageGroup, index) => (
                <div key={index}>
                  <div style={{ textAlign: "left" }}>
                    ...
                    >
                      <EnvironmentFilled /> Nha Trang- Tour
                    </h1>
                  </div>
                  <div>
                    <div
              ...
              <Card style={{ marginBottom: "0px" }}>
                ...
                >
                  ...
                  >
                    ...
                    sẽ có trong chuyến hành trình tại Nha Trang. Ngoài ra, bạn
                    còn có cơ hội tham quan các điểm đến nổi tiếng như Vinpearl
                    Land, Tháp Ponagar, Bãi Dài, và nhiều địa điểm khác.
                  </Text>
                  <br />
                  <div class="schedule">
                    <div class="schedule-item">
                      ...
                      <div>
                        Xe và hướng dẫn viên đón khách tại điểm hẹn khởi hành từ
                        Hà Nội.
                      </div>
                    </div>
                    <div class="schedule-item">
                      ...
                      <div>
                        Dừng chân để thư giãn và dùng điểm tâm trên đường. Quý
                        khách cũng có thể tham quan các điểm du lịch nổi tiếng
                        trên đoạn đường như Chùa Hương, Khu di tích Lịch sử
                        Thăng Long.
                      </div>
                    </div>
                    <div class="schedule-item">
                      <div class="time">11:30-13:00</div>
                      <div>Tiếp tục hành trình đến Nha Trang.</div>
                    </div>
                    <div class="schedule-item">
                      <div class="time">13:00-14:00</div>
                      <div>
                        Dùng bữa trưa tại nhà hàng địa phương để thưởng thức các
                        món ăn đặc sản của Nha Trang.
                      </div>
                    </div>
                    <div class="schedule-item">
                      <div class="time">14:00-17:00</div>
                      <div>
                        Thăm quan các điểm du lịch nổi tiếng tại Nha Trang như
                        Vinpearl Land, Tháp Ponagar, Bãi Dài.
                      </div>
                    </div>
                    <div class="schedule-item">
                      <div class="time">17:00-18:00</div>
                      <div>
                        Quý khách có thời gian tự do để thưởng ngoạn và mua sắm
                        tại khu vực trung tâm thành phố Nha Trang.
                      </div>
                    </div>
                    <div class="schedule-item">
                      <div class="time">18:00-20:00</div>
                      <div>
                        Dùng bữa tối tại nhà hàng truyền thống và tận hưởng
                        không gian ẩm thực độc đáo của Nha Trang.
                      </div>
                    </div>
                    <div class="schedule-item">
                      <div class="time">20:00</div>
                      <div>
                        Kết thúc tour, xe đưa quý khách về lại điểm khởi hành
                        hoặc điểm hẹn tùy theo yêu cầu của quý khách.
                      </div>
                    </div>
                  </div>
                </div>
