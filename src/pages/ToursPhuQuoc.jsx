...
const TourPhuQuoc = () => {
  ...
  const carouselImages = [
    [
      "https://static.vinwonders.com/production/dien-tich-dao-phu-quoc-top-banner.jpg",
      "https://toquoc.mediacdn.vn/280518851207290880/2023/11/20/photo-1700480061878-1700480063279807040929.jpg",
      "https://res.klook.com/image/upload/fl_lossy.progressive,q_65/w_800/activities/scpxsmdk86wpudd2ynur.webp",
      "https://static.vinwonders.com/2022/07/Phu-Quoc-weather-3.jpg",
    ],
  ];
              ...
              {carouselImages.map((imageGroup, index) => (
                <div key={index}>
                  <div style={{ textAlign: "left" }}>
                    ...
                    >
                      <EnvironmentFilled /> Phú Quốc- Tour
                    </h1>
                  </div>
                  <div>
                    <div
              ...
              <Card style={{ marginBottom: "0px" }}>
                ...
                <div class="schedule">
                  ...
                  <div class="schedule-item">
                    ...
                    <div>
                      Tàu cập bến. Chia tay nhà tàu và lên xe về Phú Quốc(chỉ áp
